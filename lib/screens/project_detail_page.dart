                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  children: [
                                    const Icon(Icons.create, size: 20, color: Colors.grey),
                                    const SizedBox(width: 8),
                                    Text('创建时间: ${DateFormat('yyyy-MM-dd HH:mm:ss').format(_project!.createdAt)}'),
                                  ],
                                ),
                                ...
                                Row(
                                  children: [
                                    ...
                                    const SizedBox(width: 8),
                                    Text('更新时间: ${DateFormat('yyyy-MM-dd HH:mm:ss').format(_project!.updatedAt)}'),
                                  ],
                                ),
                              ],
                            ),
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      const SizedBox(height: 8),
                                      Text('完成率: ${_project!.statistics.completionRate}'),
                                    ],
                                  ),
                                  ...
                                  // 性能指标
                                  const Text('性能指标', style: TextStyle(fontWeight: FontWeight.bold)),
                                    ...
                                    children: [
                                      Column(
                                        children: [
                                          ...
                                          const SizedBox(height: 8),
                                          Text('响应速度', style: TextStyle(color: Colors.grey[600])),
                                          Text(_project!.statistics.performance.speed, style: const TextStyle(fontWeight: FontWeight.bold)),
                                        ],
                                      ),
                                      Column(
                                        children: [
                                          ...
                                          const SizedBox(height: 8),
                                          Text('效率', style: TextStyle(color: Colors.grey[600])),
                                          Text(_project!.statistics.performance.efficiency, style: const TextStyle(fontWeight: FontWeight.bold)),
                                        ],
                                      ),
                                      Column(
                                        children: [
                                          const Icon(Icons.storage, size: 32, color: Colors.orange),
                                          const SizedBox(height: 8),
                                          Text('资源占用', style: TextStyle(color: Colors.grey[600])),
                                          Text(_project!.statistics.performance.resourceUsage, style: const TextStyle(fontWeight: FontWeight.bold)),
                                        ],
                                      ),
                                    ],
                                  ),
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if (section.type == 'image' && section.content is List)
                                      GridView.builder(
                                        shrinkWrap: true,
                                        ...
                                        itemBuilder: (context, index) {
                                          final image = (section.content as List)[index];
                                          return Container(
                                            decoration: BoxDecoration(
                                ...
                                ..._project!.content.attachments.map((attachment) {
                                  return Card(
                                    ...
                                    child: ListTile(
                                      ...
                                      subtitle: Text('${attachment.type.toUpperCase()} • ${attachment.size}'),
                                      trailing: TextButton(
                                        onPressed: () {
                                          // 处理下载逻辑
                                          ScaffoldMessenger.of(context).showSnackBar(
                                            SnackBar(content: Text('正在下载 ${attachment.name}')),
                                          );
                                        },
                                        child: const Text('下载'),
                                      ),
